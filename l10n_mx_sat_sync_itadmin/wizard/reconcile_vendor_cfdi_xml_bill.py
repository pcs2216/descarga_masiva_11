...
class ReconcileVendorCfdiXmlBill(models.TransientModel):
    ...
    def action_reconcile(self):
        ...
        for attachment in attachments:
            ...
            if self.typo_de_combante in ['P','SP']:
                payments = payment_obj.search([('partner_id.rfc','=',client_rfc),('amount','=',total),('payment_type','=', payment_type)])
                if payments:
                ...
                invoices = invoice_obj.search([('partner_id.rfc','=',client_rfc),('amount_total','=',total),('type','=', invoice_type)])
                if invoices:
